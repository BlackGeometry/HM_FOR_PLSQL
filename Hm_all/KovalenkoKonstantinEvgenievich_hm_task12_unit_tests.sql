...
BEGIN 
    v_payment_id := f_create_payment(p_pay_cr_sum     =>  v_pay_cr_sum, 
...
BEGIN 
    pr_fail_payment(p_payment_id    =>  v_payment_id, 
...
BEGIN 
    pr_cancel_payment(p_payment_id    =>  v_payment_id, 
...
BEGIN 
    pr_successful_finish_payment(p_payment_id    =>  v_payment_id);                                                                                           
   COMMIT;
...
BEGIN 
    pr_insert_or_update_payment_detail(p_payment_id     =>  v_payment_id,
